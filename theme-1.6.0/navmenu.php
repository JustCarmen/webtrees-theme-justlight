...
class JL_NavMenu {
	...
	public static function getGedcomMenu(){
		return self::getNavMenu(
			...
			'index.php?ctype=gedcom&amp;ged='.WT_GEDURL,
			'menu-tree',
			'gedcom'
		);
	}	
	...
	public static function getMyPageMenu(){		
		...
		return self::getNavMenu(
			...
			'index.php?ctype=user&amp;ged='.WT_GEDURL,
			'menu-mypage',
			'mypage'
		);
	}	
	...
	public static function getListsMenu(){
		return self::getNavMenu(
			WT_I18N::translate('Lists'),
			'indilist.php?ged='.WT_GEDURL,
			'menu-list',
			'lists'
		);
	}
	...
	public static function getReportsMenu(){
		...
		return self::getNavMenu(
			...
			'reportengine.php?ged='.WT_GEDURL,
			'menu-report',
			'reports'
		);
	}
