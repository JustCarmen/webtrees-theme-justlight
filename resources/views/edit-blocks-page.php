...
<form name="config_setup" method="post" action="<?= e($url_save) ?>" onsubmit="select_options();" >
	<?= csrf_field() ?>
	<table id="change_blocks" class="table jc-edit-blocks-table">
		<thead>
		  <tr class="jc-edit-blocks-header">
				<th class="descriptionbox center vmiddle" colspan="2">
					<label class="mb-0" for="main_select">
						<?= I18N::translate('Main section blocks') ?>
					</label>
				</th>
				<th class="descriptionbox center vmiddle" colspan="3">
					<label class="mb-0" for="available_select">
						<?= I18N::translate('Available blocks') ?>
					</label>
				</th>
				<th class="descriptionbox center vmiddle" colspan="2">
					<label class="mb-0" for="side_select">
		...
		<tbody>
			<tr>
				<td class="optionbox center vmiddle jc-edit-blocks-arrows">
		...
		<tfoot>
		  <tr class="jc-edit-blocks-footer">
			...
			<tr>
				<td class="topbottombar pl-0" colspan="4">
					<?php if ($can_reset): ?>
						<label>
				...
				<td class="topbottombar text-right pr-0" colspan="3">
